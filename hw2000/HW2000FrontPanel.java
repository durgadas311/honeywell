...
public class HW2000FrontPanel extends JFrame
	...
	private void partControlPanel() {
		...
		eintr.setPreferredSize(new Dimension(50, 10));
		...
		iintr.setPreferredSize(new Dimension(50, 10));
		gc.gridy = 7;
		gc.anchor = GridBagConstraints.SOUTH;
		...
		pgm.setOpaque(false);
		pgm.setPreferredSize(new Dimension(50, 10));
		gc.anchor = GridBagConstraints.SOUTH;
		...
		prot.setPreferredSize(new Dimension(50, 10));
		gc.gridy = 7;
		gc.anchor = GridBagConstraints.SOUTH;
		...
		voltage.setPreferredSize(new Dimension(80, 10));
		gc.anchor = GridBagConstraints.SOUTH;
		...
		parity.setPreferredSize(new Dimension(80, 10));
		gc.gridy = 7;
		gc.anchor = GridBagConstraints.SOUTH;
		...
		fan.setOpaque(false);
		fan.setPreferredSize(new Dimension(40, 10));
		gc.anchor = GridBagConstraints.SOUTH;
		...
		cb.setOpaque(false);
		cb.setPreferredSize(new Dimension(40, 10));
		gc.gridy = 7;
		gc.anchor = GridBagConstraints.SOUTH;
