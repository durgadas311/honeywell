 ...
 * TI990 port: the register expression stack starts at R2,
 * so to have at least 3 expression registers, R2..4 must
 * be free and regvar must remain at least 5.
 */
#define MINVAR 5
