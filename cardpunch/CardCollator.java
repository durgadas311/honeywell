...
class CardCollator implements Machine, ActionListener, Runnable
{
	...
	class TracingEntry extends ProgStart {
		public TracingEntry(boolean f) {
			super(f);
		}
		@Override
		...
		@Override
		public boolean is() {
			System.err.format("is %s\n", bool);
			return super.is();
		}
		@Override
		public void reset() {
			System.err.format("reset\n");
			super.reset();
		}
		@Override
		public void putCol(int p, char c) {
			System.err.format("putCol %03x '%c'\n", p, c);
			super.putCol(p, c);
		}
		@Override
		public void addWatcher(ProgStart ps) {
			System.err.format("add watcher\n");
			super.addWatcher(ps);
		}
	}
